cask "planwell" do
  ...
  url "https://github.com/cucumbers2blue/planwell-releases/releases/download/desktop-v#{version}/PlanWell.md-macOS-arm64.zip",
      verified: "github.com/cucumbers2blue/planwell-releases/"
  name "PlanWell.md"
  desc "Teacher planning application with dual user modes and full Obsidian sync"
  homepage "https://planwellmd.com"

  livecheck do
    url "https://github.com/cucumbers2blue/planwell-releases/releases/latest"
